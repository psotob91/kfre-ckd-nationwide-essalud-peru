...
tab1a |>  
  as_flex_table() |>  
  flextable::save_as_docx(path = here("Tables", "Sensitivity-woWinsorize", "Table1_Imputed.docx"))
...
tabS1 %>% 
  as_flex_table() %>% 
  flextable::save_as_docx(path = here("Tables", "Sensitivity-woWinsorize", "Table_Sup_S1_by_missing_3a4.docx"))
...
tabS2 %>% 
  as_flex_table() %>% 
  flextable::save_as_docx(path = here("Tables", "Sensitivity-woWinsorize", "Table_Sup_S2_Outcome_by_missing_3a4.docx"))
...
tab_cas |>  
  as_flex_table() |> 
  flextable::save_as_docx(path = here("Tables", "Sensitivity-woWinsorize", "Table_Network_Dist.docx"))
...
```{r}
include_graphics(here("Figures", "Sensitivity-woWinsorize", "map_coverage.jpeg"))
```
...
tab_cif1 %>% 
  save_as_docx(path = here("Tables", "Sensitivity-woWinsorize", "Table_CI_KF_3a4_imputed.docx"))
...
knitr::include_graphics(here("Figures", "Sensitivity-woWinsorize", "Plot_CIF_imputed.jpeg"))
```
...
```{r}
include_graphics(here("Figures", "Sensitivity-woWinsorize", "predictor_dist_overall.jpeg"))
```
...
```{r}
include_graphics(here("Figures", "Sensitivity-woWinsorize", "predicted_risk.jpeg"))
```
