...
dataA <- readRDS(here::here("Data", "Tidy", 
                                "Sensitivity-woWinsorize", "data_impA.rds")) 
...
export(df_recal_modA, here("Data", "Tidy", "Sensitivity-woWinsorize", "equations", 
                            "df_recal_modA.rds"))
head(df_recal_modA)
```
...
export(df_recal_modB, here("Data", "Tidy", "Sensitivity-woWinsorize", "equations", 
                           "df_recal_modB.rds"))
head(df_recal_modB)
```
...
export(df_recal_modC, here("Data", "Tidy", "Sensitivity-woWinsorize", "equations", 
                           "df_recal_modC.rds"))
head(df_recal_modC)
```
...
export(df_recal_modD, here("Data", "Tidy", "Sensitivity-woWinsorize", "equations", 
                           "df_recal_modD.rds"))
head(df_recal_modD)
```
...
export(datos.recal, here("Data", "Tidy", "Sensitivity-woWinsorize", "equations", 
                         "recal_loads.rds" ))
